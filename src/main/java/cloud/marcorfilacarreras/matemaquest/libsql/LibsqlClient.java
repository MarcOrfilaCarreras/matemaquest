...
public class LibsqlClient {
   ...
   */
  public LibsqlResultSet execute(String stmt) {
   ...
   */
  public LibsqlResultSet[] batch(String[] stmts) {
    try {
      ...
      try (InputStreamReader in = new InputStreamReader(conn.getInputStream(), StandardCharsets.UTF_8)) {
        ...
        LibsqlResultSet[] resultSets = new LibsqlResultSet[response.length];
  ...
  public static class Response {
    public LibsqlResultSet results;
  }
